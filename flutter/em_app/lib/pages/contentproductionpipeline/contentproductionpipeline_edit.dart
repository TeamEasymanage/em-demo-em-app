...
class ContentProductionPipelineEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final int idSelected; 
  const ContentProductionPipelineEdit({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _ContentProductionPipelineEditState createState() => _ContentProductionPipelineEditState(); 
} 
 
class _ContentProductionPipelineEditState extends State<ContentProductionPipelineEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("ContentProductionPipeline Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return ContentProductionPipelineEditRec( 	
...
class ContentProductionPipelineEditRec extends StatefulWidget { 
  final ContentProductionPipeline contentProductionPipeline; 
  const ContentProductionPipelineEditRec({Key? key, required this.contentProductionPipeline}) : super(key: key); 
 
  @override 
  _ContentProductionPipelineEditRecState createState() => _ContentProductionPipelineEditRecState(); 
} 
 
class _ContentProductionPipelineEditRecState extends State<ContentProductionPipelineEditRec> { 
