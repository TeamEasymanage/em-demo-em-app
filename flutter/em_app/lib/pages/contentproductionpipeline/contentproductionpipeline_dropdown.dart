...
class ContentProductionPipelineEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final int idSelected; 
  const ContentProductionPipelineEditDd({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _ContentProductionPipelineEditDdState createState() => _ContentProductionPipelineEditDdState(); 
} 
 
class _ContentProductionPipelineEditDdState extends State<ContentProductionPipelineEditDd> { 
  ...
  void initState() {	
    ...
    ContentProductionPipelineService.ContentProductionPipelineViewAllIds().then((ids) { 	
      if (ids is String) {	
        setState(() {	
          errorMsg = ids;	
        });	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("ContentProductionPipeline Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
                ...
                child: Row(	
                  ...
                  children: [	
                    Padding(	
                      ...
                      _isKeySelected 	
                          ? FutureBuilder<ContentProductionPipeline>( 	
                              future: ContentProductionPipelineService 	
                                      .ContentProductionPipelineQuery(getEmIntStr(_chosenValue)) 	
                                  .then((value) => value), 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return ContentProductionPipelineEditDdRec( 	
                                          contentProductionPipeline: snapshot.data!); 	
                                    } 	
                                } 	
                              }) 	
                          : const SizedBox( 	
...
class ContentProductionPipelineEditDdRec extends StatefulWidget { 
  final ContentProductionPipeline contentProductionPipeline; 
  const ContentProductionPipelineEditDdRec({Key? key, required this.contentProductionPipeline}) : super(key: key); 
 
  @override 
  _ContentProductionPipelineEditDdRecState createState() => _ContentProductionPipelineEditDdRecState(); 
} 
 
class _ContentProductionPipelineEditDdRecState extends State<ContentProductionPipelineEditDdRec> { 
  ContentProductionPipeline foundContentProductionPipeline = ContentProductionPipeline(id: 0 ); 
...
void didChangeDependencies() { 
  ...
  void initState() { 
    super.initState(); 
    setState(() { 
      foundContentProductionPipeline = widget.contentProductionPipeline; 
			      _textEditingController6.text = getEmStrOpt(foundContentProductionPipeline.dueDate); 
    }); 
  } 
            ...
            child: Form( 
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					   enabled: false,    initialValue: getEmStrOpt(foundContentProductionPipeline.id.toString()),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundContentProductionPipeline.name),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundContentProductionPipeline.status),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundContentProductionPipeline.headline),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundContentProductionPipeline.creator),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				controller: _textEditingController6,  
					    //IS-PICKER  initialValue: getEmStrOpt(foundContentProductionPipeline.dueDate),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundContentProductionPipeline.channels),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
                    ...
                    builder: (context) => ButtonWidget( 
                      ...
                      onClicked: () { 
					   ...
					   channels: channelsVar , 
                          ...
                          ContentProductionPipelineService.ContentProductionPipelineEdit( 
                                  newContentProductionPipeline.id, 
                                  newContentProductionPipeline) 
                              .then((message) { 
