...
class LocalBusinessClientEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final int idSelected; 
  const LocalBusinessClientEditDd({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _LocalBusinessClientEditDdState createState() => _LocalBusinessClientEditDdState(); 
} 
 
class _LocalBusinessClientEditDdState extends State<LocalBusinessClientEditDd> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("LocalBusinessClient Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return LocalBusinessClientEditDdRec( 	
...
class LocalBusinessClientEditDdRec extends StatefulWidget { 
  final LocalBusinessClient localBusinessClient; 
  const LocalBusinessClientEditDdRec({Key? key, required this.localBusinessClient}) : super(key: key); 
 
  @override 
  _LocalBusinessClientEditDdRecState createState() => _LocalBusinessClientEditDdRecState(); 
} 
 
class _LocalBusinessClientEditDdRecState extends State<LocalBusinessClientEditDdRec> { 
