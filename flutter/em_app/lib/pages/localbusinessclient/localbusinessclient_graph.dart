...
class LocalBusinessClientGraph extends StatefulWidget { 	
  const LocalBusinessClientGraph({Key? key}) : super(key: key); 	
	 	
  @override 	
  _LocalBusinessClientGraphState createState() => _LocalBusinessClientGraphState(); 	
} 	
	 	
class _LocalBusinessClientGraphState extends State<LocalBusinessClientGraph> { 	
 	
  //List<LocalBusinessClient> localBusinessClientList = []; 	
  List<EmChartModel> localBusinessClientList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    ...
    setState(() { 	
      ...
      localBusinessClientList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'LocalBusinessClient Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
                    ...
                    child: Container( 	
                      ...
                      child: Padding( 	
                        ...
                        child: (_chartOptSel == 'BarChart') 	
                            ? BarChartSample2( 	
                                localBusinessClientList: localBusinessClientList) 	
                            : LineChart(lineChartLocalBusinessClient()), 	
                      ), 	
                    ), 	
                  ), 	
                ], 	
  ...
  LineChartData lineChartLocalBusinessClient() { 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> localBusinessClientList; 	
  const BarChartSample2({Key? key, required this.localBusinessClientList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.localBusinessClientList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	
