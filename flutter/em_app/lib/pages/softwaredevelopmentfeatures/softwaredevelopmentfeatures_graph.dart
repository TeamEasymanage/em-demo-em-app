...
class SoftwareDevelopmentFeaturesGraph extends StatefulWidget { 	
  const SoftwareDevelopmentFeaturesGraph({Key? key}) : super(key: key); 	
	 	
  @override 	
  _SoftwareDevelopmentFeaturesGraphState createState() => _SoftwareDevelopmentFeaturesGraphState(); 	
} 	
	 	
class _SoftwareDevelopmentFeaturesGraphState extends State<SoftwareDevelopmentFeaturesGraph> { 	
 	
  //List<SoftwareDevelopmentFeatures> softwareDevelopmentFeaturesList = []; 	
  List<EmChartModel> softwareDevelopmentFeaturesList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    ...
    setState(() { 	
      ...
      softwareDevelopmentFeaturesList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'SoftwareDevelopmentFeatures Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
                    ...
                    child: Container( 	
                      ...
                      child: Padding( 	
                        ...
                        child: (_chartOptSel == 'BarChart') 	
                            ? BarChartSample2( 	
                                softwareDevelopmentFeaturesList: softwareDevelopmentFeaturesList) 	
                            : LineChart(lineChartSoftwareDevelopmentFeatures()), 	
                      ), 	
                    ), 	
                  ), 	
                ], 	
  ...
  LineChartData lineChartSoftwareDevelopmentFeatures() { 	
    ...
    return LineChartData( 	
      ...
      lineBarsData: [ 	
        LineChartBarData( 	
          spots: softwareDevelopmentFeaturesList 	
              //.sublist(0, 10) 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> softwareDevelopmentFeaturesList; 	
  const BarChartSample2({Key? key, required this.softwareDevelopmentFeaturesList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.softwareDevelopmentFeaturesList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	
