...
class SoftwareDevelopmentFeaturesEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final int idSelected; 
  const SoftwareDevelopmentFeaturesEditDd({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _SoftwareDevelopmentFeaturesEditDdState createState() => _SoftwareDevelopmentFeaturesEditDdState(); 
} 
 
class _SoftwareDevelopmentFeaturesEditDdState extends State<SoftwareDevelopmentFeaturesEditDd> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("SoftwareDevelopmentFeatures Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return SoftwareDevelopmentFeaturesEditDdRec( 	
...
class SoftwareDevelopmentFeaturesEditDdRec extends StatefulWidget { 
  final SoftwareDevelopmentFeatures softwareDevelopmentFeatures; 
  const SoftwareDevelopmentFeaturesEditDdRec({Key? key, required this.softwareDevelopmentFeatures}) : super(key: key); 
 
  @override 
  _SoftwareDevelopmentFeaturesEditDdRecState createState() => _SoftwareDevelopmentFeaturesEditDdRecState(); 
} 
 
class _SoftwareDevelopmentFeaturesEditDdRecState extends State<SoftwareDevelopmentFeaturesEditDdRec> { 
