...
class CreativeTalentRoleGraph extends StatefulWidget { 	
  const CreativeTalentRoleGraph({Key? key}) : super(key: key); 	
	 	
  @override 	
  _CreativeTalentRoleGraphState createState() => _CreativeTalentRoleGraphState(); 	
} 	
	 	
class _CreativeTalentRoleGraphState extends State<CreativeTalentRoleGraph> { 	
 	
  //List<CreativeTalentRole> creativeTalentRoleList = []; 	
  List<EmChartModel> creativeTalentRoleList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    ...
    setState(() { 	
      ...
      creativeTalentRoleList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'CreativeTalentRole Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
                    ...
                    child: Container( 	
                      ...
                      child: Padding( 	
                        ...
                        child: (_chartOptSel == 'BarChart') 	
                            ? BarChartSample2( 	
                                creativeTalentRoleList: creativeTalentRoleList) 	
                            : LineChart(lineChartCreativeTalentRole()), 	
                      ), 	
                    ), 	
                  ), 	
                ], 	
  ...
  LineChartData lineChartCreativeTalentRole() { 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> creativeTalentRoleList; 	
  const BarChartSample2({Key? key, required this.creativeTalentRoleList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.creativeTalentRoleList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	
