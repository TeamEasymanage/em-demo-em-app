...
class PersonalAllCoursesGraph extends StatefulWidget { 	
  const PersonalAllCoursesGraph({Key? key}) : super(key: key); 	
	 	
  @override 	
  _PersonalAllCoursesGraphState createState() => _PersonalAllCoursesGraphState(); 	
} 	
	 	
class _PersonalAllCoursesGraphState extends State<PersonalAllCoursesGraph> { 	
 	
  //List<PersonalAllCourses> personalAllCoursesList = []; 	
  List<EmChartModel> personalAllCoursesList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    ...
    setState(() { 	
      ...
      personalAllCoursesList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'PersonalAllCourses Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
                    ...
                    child: Container( 	
                      ...
                      child: Padding( 	
                        ...
                        child: (_chartOptSel == 'BarChart') 	
                            ? BarChartSample2( 	
                                personalAllCoursesList: personalAllCoursesList) 	
                            : LineChart(lineChartPersonalAllCourses()), 	
                      ), 	
                    ), 	
                  ), 	
                ], 	
  ...
  LineChartData lineChartPersonalAllCourses() { 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> personalAllCoursesList; 	
  const BarChartSample2({Key? key, required this.personalAllCoursesList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.personalAllCoursesList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	
