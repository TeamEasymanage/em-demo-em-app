 ...
 */ 
	...
	SingleChildScrollView FeaturedEventSchedule_dispForm(BuildContext context, FeaturedEventSchedule foundFeaturedEventSchedule) { 	
        ...
        child: Flex(	
          ...
          children: [	
            Table(	
	            ...
	            children: foundFeaturedEventSchedule 	
	                .toListLabVal() 	
...
Widget getFieldTextOrMedia(BuildContext context, String fldName, String? fldVal) { 
 ...
 //     And replace "Product Picture" with correct field label for your field  
  ...
  return Text(getEmStrOpt(fldVal)); 
} 
