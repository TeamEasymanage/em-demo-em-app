...
class StudentGraph extends StatefulWidget { 	
  ...
  @override 	
  _StudentGraphState createState() => _StudentGraphState(); 	
} 	
	 	
class _StudentGraphState extends State<StudentGraph> { 	
 	
  //List<Student> studentList = []; 	
  List<EmChartModel> studentList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    ...
    setState(() { 	
      ...
      studentList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'Student Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
  ...
  LineChartData lineChartStudent() { 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> studentList; 	
  const BarChartSample2({Key? key, required this.studentList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.studentList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	
