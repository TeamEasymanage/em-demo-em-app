...
class SalesCustomerResponseEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final int idSelected; 
  const SalesCustomerResponseEditDd({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _SalesCustomerResponseEditDdState createState() => _SalesCustomerResponseEditDdState(); 
} 
 
class _SalesCustomerResponseEditDdState extends State<SalesCustomerResponseEditDd> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("SalesCustomerResponse Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return SalesCustomerResponseEditDdRec( 	
...
class SalesCustomerResponseEditDdRec extends StatefulWidget { 
  final SalesCustomerResponse salesCustomerResponse; 
  const SalesCustomerResponseEditDdRec({Key? key, required this.salesCustomerResponse}) : super(key: key); 
 
  @override 
  _SalesCustomerResponseEditDdRecState createState() => _SalesCustomerResponseEditDdRecState(); 
} 
 
class _SalesCustomerResponseEditDdRecState extends State<SalesCustomerResponseEditDdRec> { 
