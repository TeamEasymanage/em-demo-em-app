...
class SalesCustomerResponseGraph extends StatefulWidget { 	
  const SalesCustomerResponseGraph({Key? key}) : super(key: key); 	
	 	
  @override 	
  _SalesCustomerResponseGraphState createState() => _SalesCustomerResponseGraphState(); 	
} 	
	 	
class _SalesCustomerResponseGraphState extends State<SalesCustomerResponseGraph> { 	
 	
  //List<SalesCustomerResponse> salesCustomerResponseList = []; 	
  List<EmChartModel> salesCustomerResponseList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    ...
    setState(() { 	
      ...
      salesCustomerResponseList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'SalesCustomerResponse Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
                    ...
                    child: Container( 	
                      ...
                      child: Padding( 	
                        ...
                        child: (_chartOptSel == 'BarChart') 	
                            ? BarChartSample2( 	
                                salesCustomerResponseList: salesCustomerResponseList) 	
                            : LineChart(lineChartSalesCustomerResponse()), 	
                      ), 	
                    ), 	
                  ), 	
                ], 	
  ...
  LineChartData lineChartSalesCustomerResponse() { 	
    ...
    return LineChartData( 	
      ...
      lineBarsData: [ 	
        LineChartBarData( 	
          spots: salesCustomerResponseList 	
              //.sublist(0, 10) 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> salesCustomerResponseList; 	
  const BarChartSample2({Key? key, required this.salesCustomerResponseList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.salesCustomerResponseList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	
