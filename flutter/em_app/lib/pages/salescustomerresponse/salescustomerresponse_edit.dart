...
class SalesCustomerResponseEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final int idSelected; 
  const SalesCustomerResponseEdit({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _SalesCustomerResponseEditState createState() => _SalesCustomerResponseEditState(); 
} 
 
class _SalesCustomerResponseEditState extends State<SalesCustomerResponseEdit> { 
  ...
  void initState() {	
    ...
    //Key Value passed, Edit Record Mode 	
		...
		_loading = false;	
    /*	
    SalesCustomerResponseService.SalesCustomerResponseViewAllIds().then((ids) { 	
      if (ids is String) {	
        setState(() {	
          errorMsg = ids;	
        });	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("SalesCustomerResponse Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
                ...
                child: Row(	
                  ...
                  children: [	
                    Padding(	
                      ...
                      _isKeySelected 	
                          ? FutureBuilder<SalesCustomerResponse>( 	
                              future: SalesCustomerResponseService 	
                                      .SalesCustomerResponseQuery(getEmIntStr(_chosenValue)) 	
                                  .then((value) => value), 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return SalesCustomerResponseEditRec( 	
                                          salesCustomerResponse: snapshot.data!); 	
                                    } 	
                                } 	
                              }) 	
                          : const SizedBox( 	
...
class SalesCustomerResponseEditRec extends StatefulWidget { 
  final SalesCustomerResponse salesCustomerResponse; 
  const SalesCustomerResponseEditRec({Key? key, required this.salesCustomerResponse}) : super(key: key); 
 
  @override 
  _SalesCustomerResponseEditRecState createState() => _SalesCustomerResponseEditRecState(); 
} 
 
class _SalesCustomerResponseEditRecState extends State<SalesCustomerResponseEditRec> { 
  SalesCustomerResponse foundSalesCustomerResponse = SalesCustomerResponse(id: 0 ); 
...
void didChangeDependencies() { 
  ...
  void initState() { 
    super.initState(); 
    setState(() { 
      foundSalesCustomerResponse = widget.salesCustomerResponse; 
    }); 
  } 
            ...
            child: Form( 
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					   enabled: false,    initialValue: getEmStrOpt(foundSalesCustomerResponse.id.toString()),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundSalesCustomerResponse.customerName),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundSalesCustomerResponse.submissionTime),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundSalesCustomerResponse.email),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundSalesCustomerResponse.companyName),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundSalesCustomerResponse.productSatisfaction),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundSalesCustomerResponse.serviceSatisfaction),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundSalesCustomerResponse.productComparison),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundSalesCustomerResponse.serviceComparison),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundSalesCustomerResponse.reasons),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundSalesCustomerResponse.rating.toString()),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundSalesCustomerResponse.highlight),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundSalesCustomerResponse.promoter),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundSalesCustomerResponse.insights),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
                    ...
                    builder: (context) => ButtonWidget( 
                      ...
                      onClicked: () { 
					   ...
					   insights: insightsVar , 
                          ...
                          SalesCustomerResponseService.SalesCustomerResponseEdit( 
                                  newSalesCustomerResponse.id, 
                                  newSalesCustomerResponse) 
                              .then((message) { 
