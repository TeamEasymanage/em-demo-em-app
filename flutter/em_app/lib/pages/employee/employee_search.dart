...
import 'package:em_app/pages/employee/employee_lib.dart'; 
	...
	class _EmployeeSearchState extends State<EmployeeSearch> { 	
	  ...
	  Widget build(BuildContext context) { 	
		return Scaffold( 	
	        ...
	        appBar: AppBar( 	
	          title: const Text("Employee Search Record"), 	
	          centerTitle: true, 	
	        ), 	
	                    ...
	                    children: [ 	
	                      ...
	                      _isKeySelected 	
	                          ? FutureBuilder<Employee>( 	
	                              future: EmployeeService.EmployeeQuery(_chosenValue) 	
	                                  .then((value) => value), 	
	...
	class EmployeeSearchResult extends StatelessWidget { 	
	  ...
	  const EmployeeSearchResult({Key? key, required this.foundEmployee}) : super(key: key); 	
