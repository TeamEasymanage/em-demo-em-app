...
class _EmployeeGraphState extends State<EmployeeGraph> { 	
  ...
  List<EmChartModel> employeeList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    ...
    setState(() { 	
      ...
      employeeList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'Employee Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
  ...
  LineChartData lineChartEmployee() { 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> employeeList; 	
  const BarChartSample2({Key? key, required this.employeeList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.employeeList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	
