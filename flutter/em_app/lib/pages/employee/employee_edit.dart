...
class EmployeeEdit extends StatefulWidget { 
  ...
  const EmployeeEdit({Key? key, required this.nameSelected}) : super(key: key); 
...
class _EmployeeEditState extends State<EmployeeEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("Employee Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
...
class EmployeeEditRec extends StatefulWidget { 
  final Employee employee; 
  const EmployeeEditRec({Key? key, required this.employee}) : super(key: key); 
 
  @override 
  _EmployeeEditRecState createState() => _EmployeeEditRecState(); 
} 
 
class _EmployeeEditRecState extends State<EmployeeEditRec> { 
