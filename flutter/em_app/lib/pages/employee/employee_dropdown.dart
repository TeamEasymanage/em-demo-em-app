...
class EmployeeEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final String nameSelected; 
  const EmployeeEditDd({Key? key, required this.nameSelected}) : super(key: key); 
 
  @override 
  _EmployeeEditDdState createState() => _EmployeeEditDdState(); 
} 
 
class _EmployeeEditDdState extends State<EmployeeEditDd> { 
  ...
  void initState() {	
    ...
    EmployeeService.EmployeeViewAllIds().then((ids) { 	
      if (ids is String) {	
        setState(() {	
          errorMsg = ids;	
        });	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("Employee Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
...
class EmployeeEditDdRec extends StatefulWidget { 
  final Employee employee; 
  const EmployeeEditDdRec({Key? key, required this.employee}) : super(key: key); 
 
  @override 
  _EmployeeEditDdRecState createState() => _EmployeeEditDdRecState(); 
} 
 
class _EmployeeEditDdRecState extends State<EmployeeEditDdRec> { 
  Employee foundEmployee = Employee(name: "" ); 
            ...
            child: Form( 
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					   enabled: false,    initialValue: getEmStrOpt(foundEmployee.name),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				  ...
				  // ---------------------------------------------------------------------------------------  
				  // Column Details:  Srl No : [2] [ Name [Address] : EM Type [CHAR], Java Type [String]  
				  //                  EM size: maxlength: 255, Display Size : 20 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundEmployee.address),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
                  ...
                  const SizedBox(height: 10), 
				  // ---------------------------------------------------------------------------------------  
				  // Column Details:  Srl No : [3] [ Name [Mobile] : EM Type [CHAR], Java Type [String]  
				  //                  EM size: maxlength: 255, Display Size : 20 
				  // Flutter Details: Field Label [Mobile], Name [mobile], Type [String]  
				  // ---------------------------------------------------------------------------------------  
				Row( 
				  mainAxisAlignment: MainAxisAlignment.spaceBetween, 
				  children: <Widget>[ 
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundEmployee.mobile),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
					...
					*/  
					//maxLength: 30, 
					onSaved: (value) => setState(() => mobileVar = value.toString()), 
				  ), //textformfield 
				), //flexible 
				]), //Widget[] //Row 
                  const SizedBox(height: 10), 
