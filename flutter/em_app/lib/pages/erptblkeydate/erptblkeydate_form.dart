...
class ErpTblkeydateForm extends StatefulWidget { 
  const ErpTblkeydateForm({Key? key}) : super(key: key); 
 
  @override 
  _ErpTblkeydateFormState createState() => _ErpTblkeydateFormState(); 
} 
 
class _ErpTblkeydateFormState extends State<ErpTblkeydateForm> { 
...
void didChangeDependencies() { 
  ...
  Widget build(BuildContext context) { 
	return Scaffold( 
        ...
        appBar: AppBar( 
          title: const Text("ErpTblkeydate Add Form"), 
          centerTitle: true, 
        ), 
        body: Center( 
          child: Padding( 
            ...
            child: SingleChildScrollView(
              ...
              child: Padding( 
				...
				controller: _textEditingController1,  
					//EDT-INIT-VAL   enabled: false,  //IS-PICKER  initialValue: getEmStrOpt(foundRecord.dateofinquiry),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
 ...
 */ 
					   ...
					   updated: updatedVar , 
                          ...
                          ErpTblkeydateService.ErpTblkeydateCreate( 
                                  newErpTblkeydate.toJson()) 
                              .then((message) { 
                                    message == "ErpTblkeydate Added Successfully" 
                                        ? null	
                                        : showDialog(	
                                            context: context,	
