...
class NonProfitDonationsForm extends StatefulWidget { 
  const NonProfitDonationsForm({Key? key}) : super(key: key); 
 
  @override 
  _NonProfitDonationsFormState createState() => _NonProfitDonationsFormState(); 
} 
 
class _NonProfitDonationsFormState extends State<NonProfitDonationsForm> { 
...
void didChangeDependencies() { 
  ...
  Widget build(BuildContext context) { 
	return Scaffold( 
        ...
        appBar: AppBar( 
          title: const Text("NonProfitDonations Add Form"), 
          centerTitle: true, 
        ), 
        body: Center( 
          child: Padding( 
            ...
            child: SingleChildScrollView(
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.giftId),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.designatedProgram),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.amount),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.donor),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				controller: _textEditingController6,  
					//EDT-INIT-VAL    //IS-PICKER  initialValue: getEmStrOpt(foundRecord.firstContacted),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				controller: _textEditingController7,  
					//EDT-INIT-VAL    //IS-PICKER  initialValue: getEmStrOpt(foundRecord.dateOfDonation),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
 ...
 */ 
					   ...
					   dateOfDonation: dateOfDonationVar , 
                          ...
                          NonProfitDonationsService.NonProfitDonationsCreate( 
                                  newNonProfitDonations.toJson()) 
                              .then((message) { 
                                    message == "NonProfitDonations Added Successfully" 
                                        ? null	
                                        : showDialog(	
                                            context: context,	
