...
class NonProfitDonationsEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final int idSelected; 
  const NonProfitDonationsEditDd({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _NonProfitDonationsEditDdState createState() => _NonProfitDonationsEditDdState(); 
} 
 
class _NonProfitDonationsEditDdState extends State<NonProfitDonationsEditDd> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("NonProfitDonations Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return NonProfitDonationsEditDdRec( 	
...
class NonProfitDonationsEditDdRec extends StatefulWidget { 
  final NonProfitDonations nonProfitDonations; 
  const NonProfitDonationsEditDdRec({Key? key, required this.nonProfitDonations}) : super(key: key); 
 
  @override 
  _NonProfitDonationsEditDdRecState createState() => _NonProfitDonationsEditDdRecState(); 
} 
 
class _NonProfitDonationsEditDdRecState extends State<NonProfitDonationsEditDdRec> { 
