...
class NonProfitDonationsGraph extends StatefulWidget { 	
  const NonProfitDonationsGraph({Key? key}) : super(key: key); 	
	 	
  @override 	
  _NonProfitDonationsGraphState createState() => _NonProfitDonationsGraphState(); 	
} 	
	 	
class _NonProfitDonationsGraphState extends State<NonProfitDonationsGraph> { 	
 	
  //List<NonProfitDonations> nonProfitDonationsList = []; 	
  List<EmChartModel> nonProfitDonationsList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    ...
    setState(() { 	
      ...
      nonProfitDonationsList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'NonProfitDonations Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
                    ...
                    child: Container( 	
                      ...
                      child: Padding( 	
                        ...
                        child: (_chartOptSel == 'BarChart') 	
                            ? BarChartSample2( 	
                                nonProfitDonationsList: nonProfitDonationsList) 	
                            : LineChart(lineChartNonProfitDonations()), 	
                      ), 	
                    ), 	
                  ), 	
                ], 	
  ...
  LineChartData lineChartNonProfitDonations() { 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> nonProfitDonationsList; 	
  const BarChartSample2({Key? key, required this.nonProfitDonationsList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.nonProfitDonationsList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	
