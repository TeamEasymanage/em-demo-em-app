...
class RecruitingAllEmployeesEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final int idSelected; 
  const RecruitingAllEmployeesEditDd({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _RecruitingAllEmployeesEditDdState createState() => _RecruitingAllEmployeesEditDdState(); 
} 
 
class _RecruitingAllEmployeesEditDdState extends State<RecruitingAllEmployeesEditDd> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("RecruitingAllEmployees Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return RecruitingAllEmployeesEditDdRec( 	
...
class RecruitingAllEmployeesEditDdRec extends StatefulWidget { 
  final RecruitingAllEmployees recruitingAllEmployees; 
  const RecruitingAllEmployeesEditDdRec({Key? key, required this.recruitingAllEmployees}) : super(key: key); 
 
  @override 
  _RecruitingAllEmployeesEditDdRecState createState() => _RecruitingAllEmployeesEditDdRecState(); 
} 
 
class _RecruitingAllEmployeesEditDdRecState extends State<RecruitingAllEmployeesEditDdRec> { 
