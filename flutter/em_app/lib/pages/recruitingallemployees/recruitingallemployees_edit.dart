...
class RecruitingAllEmployeesEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final int idSelected; 
  const RecruitingAllEmployeesEdit({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _RecruitingAllEmployeesEditState createState() => _RecruitingAllEmployeesEditState(); 
} 
 
class _RecruitingAllEmployeesEditState extends State<RecruitingAllEmployeesEdit> { 
  ...
  void initState() {	
    ...
    //Key Value passed, Edit Record Mode 	
		...
		_loading = false;	
    /*	
    RecruitingAllEmployeesService.RecruitingAllEmployeesViewAllIds().then((ids) { 	
      if (ids is String) {	
        setState(() {	
          errorMsg = ids;	
        });	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("RecruitingAllEmployees Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
                    ...
                    Padding(	
                      ...
                      _isKeySelected 	
                          ? FutureBuilder<RecruitingAllEmployees>( 	
                              future: RecruitingAllEmployeesService 	
                                      .RecruitingAllEmployeesQuery(getEmIntStr(_chosenValue)) 	
                                  .then((value) => value), 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return RecruitingAllEmployeesEditRec( 	
                                          recruitingAllEmployees: snapshot.data!); 	
                                    } 	
                                } 	
                              }) 	
                          : const SizedBox( 	
...
class RecruitingAllEmployeesEditRec extends StatefulWidget { 
  final RecruitingAllEmployees recruitingAllEmployees; 
  const RecruitingAllEmployeesEditRec({Key? key, required this.recruitingAllEmployees}) : super(key: key); 
 
  @override 
  _RecruitingAllEmployeesEditRecState createState() => _RecruitingAllEmployeesEditRecState(); 
} 
 
class _RecruitingAllEmployeesEditRecState extends State<RecruitingAllEmployeesEditRec> { 
  RecruitingAllEmployees foundRecruitingAllEmployees = RecruitingAllEmployees(id: 0 ); 
...
void didChangeDependencies() { 
  ...
  void initState() { 
    super.initState(); 
    setState(() { 
      foundRecruitingAllEmployees = widget.recruitingAllEmployees; 
			      _textEditingController6.text = getEmStrOpt(foundRecruitingAllEmployees.startDate); 
			      _textEditingController10.text = getEmStrOpt(foundRecruitingAllEmployees.dob); 
    }); 
  } 
            ...
            child: Form( 
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					   enabled: false,    initialValue: getEmStrOpt(foundRecruitingAllEmployees.id.toString()),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundRecruitingAllEmployees.name),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundRecruitingAllEmployees.location),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundRecruitingAllEmployees.title),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundRecruitingAllEmployees.status),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				controller: _textEditingController6,  
					    //IS-PICKER  initialValue: getEmStrOpt(foundRecruitingAllEmployees.startDate),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundRecruitingAllEmployees.department),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundRecruitingAllEmployees.reportsTo),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundRecruitingAllEmployees.emailAddress),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				controller: _textEditingController10,  
					    //IS-PICKER  initialValue: getEmStrOpt(foundRecruitingAllEmployees.dob),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
                    ...
                    builder: (context) => ButtonWidget( 
                      ...
                      onClicked: () { 
					   ...
					   dob: dobVar , 
                          ...
                          RecruitingAllEmployeesService.RecruitingAllEmployeesEdit( 
                                  newRecruitingAllEmployees.id, 
                                  newRecruitingAllEmployees) 
                              .then((message) { 
