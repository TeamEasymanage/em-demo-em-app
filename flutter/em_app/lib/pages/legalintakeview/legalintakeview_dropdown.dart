...
class LegalIntakeViewEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final int idSelected; 
  const LegalIntakeViewEditDd({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _LegalIntakeViewEditDdState createState() => _LegalIntakeViewEditDdState(); 
} 
 
class _LegalIntakeViewEditDdState extends State<LegalIntakeViewEditDd> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("LegalIntakeView Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return LegalIntakeViewEditDdRec( 	
...
class LegalIntakeViewEditDdRec extends StatefulWidget { 
  final LegalIntakeView legalIntakeView; 
  const LegalIntakeViewEditDdRec({Key? key, required this.legalIntakeView}) : super(key: key); 
 
  @override 
  _LegalIntakeViewEditDdRecState createState() => _LegalIntakeViewEditDdRecState(); 
} 
 
class _LegalIntakeViewEditDdRecState extends State<LegalIntakeViewEditDdRec> { 
