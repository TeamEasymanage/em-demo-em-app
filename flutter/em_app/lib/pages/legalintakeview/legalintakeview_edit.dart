...
class LegalIntakeViewEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final int idSelected; 
  const LegalIntakeViewEdit({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _LegalIntakeViewEditState createState() => _LegalIntakeViewEditState(); 
} 
 
class _LegalIntakeViewEditState extends State<LegalIntakeViewEdit> { 
  ...
  void initState() {	
    ...
    //Key Value passed, Edit Record Mode 	
		...
		_loading = false;	
    /*	
    LegalIntakeViewService.LegalIntakeViewViewAllIds().then((ids) { 	
      if (ids is String) {	
        setState(() {	
          errorMsg = ids;	
        });	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("LegalIntakeView Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
                ...
                child: Row(	
                  ...
                  children: [	
                    Padding(	
                      ...
                      _isKeySelected 	
                          ? FutureBuilder<LegalIntakeView>( 	
                              future: LegalIntakeViewService 	
                                      .LegalIntakeViewQuery(getEmIntStr(_chosenValue)) 	
                                  .then((value) => value), 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return LegalIntakeViewEditRec( 	
                                          legalIntakeView: snapshot.data!); 	
                                    } 	
                                } 	
                              }) 	
                          : const SizedBox( 	
...
class LegalIntakeViewEditRec extends StatefulWidget { 
  final LegalIntakeView legalIntakeView; 
  const LegalIntakeViewEditRec({Key? key, required this.legalIntakeView}) : super(key: key); 
 
  @override 
  _LegalIntakeViewEditRecState createState() => _LegalIntakeViewEditRecState(); 
} 
 
class _LegalIntakeViewEditRecState extends State<LegalIntakeViewEditRec> { 
  LegalIntakeView foundLegalIntakeView = LegalIntakeView(id: 0 ); 
...
void didChangeDependencies() { 
  ...
  void initState() { 
    super.initState(); 
    setState(() { 
      foundLegalIntakeView = widget.legalIntakeView; 
			      _textEditingController3.text = getEmStrOpt(foundLegalIntakeView.dateSubmitted); 
			      _textEditingController5.text = getEmStrOpt(foundLegalIntakeView.dateOfBirth); 
    }); 
  } 
            ...
            child: Form( 
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					   enabled: false,    initialValue: getEmStrOpt(foundLegalIntakeView.id.toString()),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundLegalIntakeView.fullName),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				controller: _textEditingController3,  
					    //IS-PICKER  initialValue: getEmStrOpt(foundLegalIntakeView.dateSubmitted),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundLegalIntakeView.reviewStatus),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				controller: _textEditingController5,  
					    //IS-PICKER  initialValue: getEmStrOpt(foundLegalIntakeView.dateOfBirth),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundLegalIntakeView.gender),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundLegalIntakeView.placeOfBirthCity),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundLegalIntakeView.driversLicenseNumber.toString()),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundLegalIntakeView.currentAddress),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundLegalIntakeView.email),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundLegalIntakeView.employmentAddressZip.toString()),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
                    ...
                    builder: (context) => ButtonWidget( 
                      ...
                      onClicked: () { 
					   ...
					   employmentAddressZip: getEmIntStrOpt(employmentAddressZipVar) , 
                          ...
                          LegalIntakeViewService.LegalIntakeViewEdit( 
                                  newLegalIntakeView.id, 
                                  newLegalIntakeView) 
                              .then((message) { 
