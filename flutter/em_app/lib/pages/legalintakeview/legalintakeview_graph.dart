...
class LegalIntakeViewGraph extends StatefulWidget { 	
  const LegalIntakeViewGraph({Key? key}) : super(key: key); 	
	 	
  @override 	
  _LegalIntakeViewGraphState createState() => _LegalIntakeViewGraphState(); 	
} 	
	 	
class _LegalIntakeViewGraphState extends State<LegalIntakeViewGraph> { 	
 	
  //List<LegalIntakeView> legalIntakeViewList = []; 	
  List<EmChartModel> legalIntakeViewList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    ...
    setState(() { 	
      ...
      legalIntakeViewList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'LegalIntakeView Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
                    ...
                    child: Container( 	
                      ...
                      child: Padding( 	
                        ...
                        child: (_chartOptSel == 'BarChart') 	
                            ? BarChartSample2( 	
                                legalIntakeViewList: legalIntakeViewList) 	
                            : LineChart(lineChartLegalIntakeView()), 	
                      ), 	
                    ), 	
                  ), 	
                ], 	
  ...
  LineChartData lineChartLegalIntakeView() { 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> legalIntakeViewList; 	
  const BarChartSample2({Key? key, required this.legalIntakeViewList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.legalIntakeViewList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	
