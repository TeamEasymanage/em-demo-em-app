...
class ProductDesignGraph extends StatefulWidget { 	
  const ProductDesignGraph({Key? key}) : super(key: key); 	
	 	
  @override 	
  _ProductDesignGraphState createState() => _ProductDesignGraphState(); 	
} 	
	 	
class _ProductDesignGraphState extends State<ProductDesignGraph> { 	
 	
  //List<ProductDesign> productDesignList = []; 	
  List<EmChartModel> productDesignList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    ...
    setState(() { 	
      ...
      productDesignList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'ProductDesign Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
                    ...
                    child: Container( 	
                      ...
                      child: Padding( 	
                        ...
                        child: (_chartOptSel == 'BarChart') 	
                            ? BarChartSample2( 	
                                productDesignList: productDesignList) 	
                            : LineChart(lineChartProductDesign()), 	
                      ), 	
                    ), 	
                  ), 	
                ], 	
  ...
  LineChartData lineChartProductDesign() { 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> productDesignList; 	
  const BarChartSample2({Key? key, required this.productDesignList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.productDesignList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	
