...
class ProductDesignEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final int idSelected; 
  const ProductDesignEditDd({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _ProductDesignEditDdState createState() => _ProductDesignEditDdState(); 
} 
 
class _ProductDesignEditDdState extends State<ProductDesignEditDd> { 
  ...
  void initState() {	
    ...
    ProductDesignService.ProductDesignViewAllIds().then((ids) { 	
      if (ids is String) {	
        setState(() {	
          errorMsg = ids;	
        });	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("ProductDesign Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
                    ...
                    Padding(	
                      ...
                      _isKeySelected 	
                          ? FutureBuilder<ProductDesign>( 	
                              future: ProductDesignService 	
                                      .ProductDesignQuery(getEmIntStr(_chosenValue)) 	
                                  .then((value) => value), 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return ProductDesignEditDdRec( 	
                                          productDesign: snapshot.data!); 	
                                    } 	
                                } 	
                              }) 	
                          : const SizedBox( 	
...
class ProductDesignEditDdRec extends StatefulWidget { 
  final ProductDesign productDesign; 
  const ProductDesignEditDdRec({Key? key, required this.productDesign}) : super(key: key); 
 
  @override 
  _ProductDesignEditDdRecState createState() => _ProductDesignEditDdRecState(); 
} 
 
class _ProductDesignEditDdRecState extends State<ProductDesignEditDdRec> { 
  ProductDesign foundProductDesign = ProductDesign(id: 0 ); 
...
void didChangeDependencies() { 
  ...
  void initState() { 
    super.initState(); 
    setState(() { 
      foundProductDesign = widget.productDesign; 
    }); 
  } 
            ...
            child: Form( 
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					   enabled: false,    initialValue: getEmStrOpt(foundProductDesign.id.toString()),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundProductDesign.keyResult),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundProductDesign.objective),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundProductDesign.driOrStakeholder),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundProductDesign.progress.toString()),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundProductDesign.goal.toString()),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundProductDesign.projects),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
                    ...
                    builder: (context) => ButtonWidget( 
                      ...
                      onClicked: () { 
					   ...
					   projects: projectsVar , 
                          ...
                          ProductDesignService.ProductDesignEdit( 
                                  newProductDesign.id, 
                                  newProductDesign) 
                              .then((message) { 
