...
class ProductDesignEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final int idSelected; 
  const ProductDesignEdit({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _ProductDesignEditState createState() => _ProductDesignEditState(); 
} 
 
class _ProductDesignEditState extends State<ProductDesignEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("ProductDesign Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
...
class ProductDesignEditRec extends StatefulWidget { 
  final ProductDesign productDesign; 
  const ProductDesignEditRec({Key? key, required this.productDesign}) : super(key: key); 
 
  @override 
  _ProductDesignEditRecState createState() => _ProductDesignEditRecState(); 
} 
 
class _ProductDesignEditRecState extends State<ProductDesignEditRec> { 
