...
class HobbiesArtViewEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final int idSelected; 
  const HobbiesArtViewEdit({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _HobbiesArtViewEditState createState() => _HobbiesArtViewEditState(); 
} 
 
class _HobbiesArtViewEditState extends State<HobbiesArtViewEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("HobbiesArtView Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
...
class HobbiesArtViewEditRec extends StatefulWidget { 
  final HobbiesArtView hobbiesArtView; 
  const HobbiesArtViewEditRec({Key? key, required this.hobbiesArtView}) : super(key: key); 
 
  @override 
  _HobbiesArtViewEditRecState createState() => _HobbiesArtViewEditRecState(); 
} 
 
class _HobbiesArtViewEditRecState extends State<HobbiesArtViewEditRec> { 
