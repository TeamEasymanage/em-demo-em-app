...
class HobbiesArtViewGraph extends StatefulWidget { 	
  const HobbiesArtViewGraph({Key? key}) : super(key: key); 	
	 	
  @override 	
  _HobbiesArtViewGraphState createState() => _HobbiesArtViewGraphState(); 	
} 	
	 	
class _HobbiesArtViewGraphState extends State<HobbiesArtViewGraph> { 	
 	
  //List<HobbiesArtView> hobbiesArtViewList = []; 	
  List<EmChartModel> hobbiesArtViewList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    ...
    setState(() { 	
      ...
      hobbiesArtViewList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'HobbiesArtView Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
                    ...
                    child: Container( 	
                      ...
                      child: Padding( 	
                        ...
                        child: (_chartOptSel == 'BarChart') 	
                            ? BarChartSample2( 	
                                hobbiesArtViewList: hobbiesArtViewList) 	
                            : LineChart(lineChartHobbiesArtView()), 	
                      ), 	
                    ), 	
                  ), 	
                ], 	
  ...
  LineChartData lineChartHobbiesArtView() { 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> hobbiesArtViewList; 	
  const BarChartSample2({Key? key, required this.hobbiesArtViewList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.hobbiesArtViewList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	
