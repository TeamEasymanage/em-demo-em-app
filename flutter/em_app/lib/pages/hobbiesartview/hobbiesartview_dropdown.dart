...
class HobbiesArtViewEditDd extends StatefulWidget { 
  //need 1st record column and type also 
  final int idSelected; 
  const HobbiesArtViewEditDd({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _HobbiesArtViewEditDdState createState() => _HobbiesArtViewEditDdState(); 
} 
 
class _HobbiesArtViewEditDdState extends State<HobbiesArtViewEditDd> { 
  ...
  void initState() {	
    ...
    HobbiesArtViewService.HobbiesArtViewViewAllIds().then((ids) { 	
      if (ids is String) {	
        setState(() {	
          errorMsg = ids;	
        });	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("HobbiesArtView Edit Dd Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
                ...
                child: Row(	
                  ...
                  children: [	
                    Padding(	
                      ...
                      _isKeySelected 	
                          ? FutureBuilder<HobbiesArtView>( 	
                              future: HobbiesArtViewService 	
                                      .HobbiesArtViewQuery(getEmIntStr(_chosenValue)) 	
                                  .then((value) => value), 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return HobbiesArtViewEditDdRec( 	
                                          hobbiesArtView: snapshot.data!); 	
                                    } 	
                                } 	
                              }) 	
                          : const SizedBox( 	
...
class HobbiesArtViewEditDdRec extends StatefulWidget { 
  final HobbiesArtView hobbiesArtView; 
  const HobbiesArtViewEditDdRec({Key? key, required this.hobbiesArtView}) : super(key: key); 
 
  @override 
  _HobbiesArtViewEditDdRecState createState() => _HobbiesArtViewEditDdRecState(); 
} 
 
class _HobbiesArtViewEditDdRecState extends State<HobbiesArtViewEditDdRec> { 
  HobbiesArtView foundHobbiesArtView = HobbiesArtView(id: 0 ); 
...
void didChangeDependencies() { 
  ...
  void initState() { 
    super.initState(); 
    setState(() { 
      foundHobbiesArtView = widget.hobbiesArtView; 
    }); 
  } 
            ...
            child: Form( 
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					   enabled: false,    initialValue: getEmStrOpt(foundHobbiesArtView.id.toString()),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundHobbiesArtView.name),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundHobbiesArtView.myPricePaid),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundHobbiesArtView.insured),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundHobbiesArtView.artist),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					      initialValue: getEmStrOpt(foundHobbiesArtView.myNotes),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
                    ...
                    builder: (context) => ButtonWidget( 
                      ...
                      onClicked: () { 
					   ...
					   myNotes: myNotesVar , 
                          ...
                          HobbiesArtViewService.HobbiesArtViewEdit( 
                                  newHobbiesArtView.id, 
                                  newHobbiesArtView) 
                              .then((message) { 
