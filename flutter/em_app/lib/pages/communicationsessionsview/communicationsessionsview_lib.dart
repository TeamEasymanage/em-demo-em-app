 ...
 */ 
	...
	SingleChildScrollView CommunicationSessionsView_dispForm(BuildContext context, CommunicationSessionsView foundCommunicationSessionsView) { 	
        ...
        child: Flex(	
          ...
          children: [	
            Table(	
	            ...
	            children: foundCommunicationSessionsView 	
	                .toListLabVal() 	
