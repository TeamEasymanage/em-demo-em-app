...
class CommunicationSessionsViewForm extends StatefulWidget { 
  const CommunicationSessionsViewForm({Key? key}) : super(key: key); 
 
  @override 
  _CommunicationSessionsViewFormState createState() => _CommunicationSessionsViewFormState(); 
} 
 
class _CommunicationSessionsViewFormState extends State<CommunicationSessionsViewForm> { 
...
void didChangeDependencies() { 
  ...
  Widget build(BuildContext context) { 
	return Scaffold( 
        ...
        appBar: AppBar( 
          title: const Text("CommunicationSessionsView Add Form"), 
          centerTitle: true, 
        ), 
        body: Center( 
          child: Padding( 
            ...
            child: SingleChildScrollView(
              ...
              child: Padding( 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.study),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				controller: _textEditingController4,  
					//EDT-INIT-VAL    //IS-PICKER  initialValue: getEmStrOpt(foundRecord.date99),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.personInterviewed),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.gotomeetingUrl),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.overallFeedbackScore),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
				...
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.sessionType),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
 ...
 */ 
					   ...
					   sessionType: sessionTypeVar , 
                          ...
                          CommunicationSessionsViewService.CommunicationSessionsViewCreate( 
                                  newCommunicationSessionsView.toJson()) 
                              .then((message) { 
                                    message == "CommunicationSessionsView Added Successfully" 
                                        ? null	
                                        : showDialog(	
                                            context: context,	
