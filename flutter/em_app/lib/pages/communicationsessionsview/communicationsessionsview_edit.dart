...
class CommunicationSessionsViewEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final int idSelected; 
  const CommunicationSessionsViewEdit({Key? key, required this.idSelected}) : super(key: key); 
 
  @override 
  _CommunicationSessionsViewEditState createState() => _CommunicationSessionsViewEditState(); 
} 
 
class _CommunicationSessionsViewEditState extends State<CommunicationSessionsViewEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("CommunicationSessionsView Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return CommunicationSessionsViewEditRec( 	
...
class CommunicationSessionsViewEditRec extends StatefulWidget { 
  final CommunicationSessionsView communicationSessionsView; 
  const CommunicationSessionsViewEditRec({Key? key, required this.communicationSessionsView}) : super(key: key); 
 
  @override 
  _CommunicationSessionsViewEditRecState createState() => _CommunicationSessionsViewEditRecState(); 
} 
 
class _CommunicationSessionsViewEditRecState extends State<CommunicationSessionsViewEditRec> { 
