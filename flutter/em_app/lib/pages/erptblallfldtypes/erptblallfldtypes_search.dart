...
import 'package:em_app/pages/erptblallfldtypes/erptblallfldtypes_lib.dart'; 
	...
	class ErpTblallfldtypesSearch extends StatefulWidget { 	
	  const ErpTblallfldtypesSearch({Key? key}) : super(key: key); 	
	 	
	  @override 	
	  _ErpTblallfldtypesSearchState createState() => _ErpTblallfldtypesSearchState(); 	
	} 	
	 	
	class _ErpTblallfldtypesSearchState extends State<ErpTblallfldtypesSearch> { 	
	  ...
	  Widget build(BuildContext context) { 	
		return Scaffold( 	
	        ...
	        appBar: AppBar( 	
	          title: const Text("ErpTblallfldtypes Search Record"), 	
	          centerTitle: true, 	
	        ), 	
	                    ...
	                    children: [ 	
	                      ...
	                      _isKeySelected 	
	                          ? FutureBuilder<ErpTblallfldtypes>( 	
	                              future: ErpTblallfldtypesService.ErpTblallfldtypesQuery(_chosenValue) 	
	                                  .then((value) => value), 	
	                                ...
	                                switch (snapshot.connectionState) { 	
	                                  ...
	                                  default: 	
	                                    if (snapshot.hasError) { 	
	                                      ...
	                                      return ErpTblallfldtypesSearchResult( 	
	                                          foundErpTblallfldtypes: snapshot.data!); 	
	                                    } 	
	                                } 	
	                              }) 	
	                          : const SizedBox( 	
	...
	class ErpTblallfldtypesSearchResult extends StatelessWidget { 	
	  final ErpTblallfldtypes foundErpTblallfldtypes; 	
	  const ErpTblallfldtypesSearchResult({Key? key, required this.foundErpTblallfldtypes}) : super(key: key); 	
