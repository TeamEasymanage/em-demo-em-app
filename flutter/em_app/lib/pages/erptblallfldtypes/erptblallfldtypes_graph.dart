...
class ErpTblallfldtypesGraph extends StatefulWidget { 	
  const ErpTblallfldtypesGraph({Key? key}) : super(key: key); 	
	 	
  @override 	
  _ErpTblallfldtypesGraphState createState() => _ErpTblallfldtypesGraphState(); 	
} 	
	 	
class _ErpTblallfldtypesGraphState extends State<ErpTblallfldtypesGraph> { 	
 	
  //List<ErpTblallfldtypes> erpTblallfldtypesList = []; 	
  List<EmChartModel> erpTblallfldtypesList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    ...
    setState(() { 	
      ...
      erpTblallfldtypesList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'ErpTblallfldtypes Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
                    ...
                    child: Container( 	
                      ...
                      child: Padding( 	
                        ...
                        child: (_chartOptSel == 'BarChart') 	
                            ? BarChartSample2( 	
                                erpTblallfldtypesList: erpTblallfldtypesList) 	
                            : LineChart(lineChartErpTblallfldtypes()), 	
                      ), 	
                    ), 	
                  ), 	
                ], 	
  ...
  LineChartData lineChartErpTblallfldtypes() { 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> erpTblallfldtypesList; 	
  const BarChartSample2({Key? key, required this.erpTblallfldtypesList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.erpTblallfldtypesList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	
