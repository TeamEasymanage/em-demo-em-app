...
class ErpTblallfldtypesEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final String personIdSelected; 
  const ErpTblallfldtypesEdit({Key? key, required this.personIdSelected}) : super(key: key); 
 
  @override 
  _ErpTblallfldtypesEditState createState() => _ErpTblallfldtypesEditState(); 
} 
 
class _ErpTblallfldtypesEditState extends State<ErpTblallfldtypesEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("ErpTblallfldtypes Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
                                ...
                                switch (snapshot.connectionState) { 	
                                  ...
                                  default: 	
                                    if (snapshot.hasError) { 	
                                      ...
                                      return ErpTblallfldtypesEditRec( 	
...
class ErpTblallfldtypesEditRec extends StatefulWidget { 
  final ErpTblallfldtypes erpTblallfldtypes; 
  const ErpTblallfldtypesEditRec({Key? key, required this.erpTblallfldtypes}) : super(key: key); 
 
  @override 
  _ErpTblallfldtypesEditRecState createState() => _ErpTblallfldtypesEditRecState(); 
} 
 
class _ErpTblallfldtypesEditRecState extends State<ErpTblallfldtypesEditRec> { 
