...
class ErpInventorySumForm extends StatefulWidget { 
  const ErpInventorySumForm({Key? key}) : super(key: key); 
 
  @override 
  _ErpInventorySumFormState createState() => _ErpInventorySumFormState(); 
} 
 
class _ErpInventorySumFormState extends State<ErpInventorySumForm> { 
...
void didChangeDependencies() { 
  ...
  Widget build(BuildContext context) { 
	return Scaffold( 
        ...
        appBar: AppBar( 
          title: const Text("ErpInventorySum Add Form"), 
          centerTitle: true, 
        ), 
        body: Center( 
          child: Padding( 
 ...
 */ 
					   ...
					   totalQty: getEmDoubleStrOpt(totalQtyVar) , 
                          ...
                          ErpInventorySumService.ErpInventorySumCreate( 
                                  newErpInventorySum.toJson()) 
                              .then((message) { 
                                    message == "ErpInventorySum Added Successfully" 
                                        ? null	
                                        : showDialog(	
                                            context: context,	
