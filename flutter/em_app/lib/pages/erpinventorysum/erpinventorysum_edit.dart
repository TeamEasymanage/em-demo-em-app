...
class ErpInventorySumEdit extends StatefulWidget { 
  //need 1st record column and type also 
  final int yearSelected; 
  const ErpInventorySumEdit({Key? key, required this.yearSelected}) : super(key: key); 
 
  @override 
  _ErpInventorySumEditState createState() => _ErpInventorySumEditState(); 
} 
 
class _ErpInventorySumEditState extends State<ErpInventorySumEdit> { 
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
        ...
        appBar: AppBar( 	
          title: const Text("ErpInventorySum Edit  Form"), 	
          centerTitle: true, 	
        ), 	
        body: _loading 	
...
class ErpInventorySumEditRec extends StatefulWidget { 
  final ErpInventorySum erpInventorySum; 
  const ErpInventorySumEditRec({Key? key, required this.erpInventorySum}) : super(key: key); 
 
  @override 
  _ErpInventorySumEditRecState createState() => _ErpInventorySumEditRecState(); 
} 
 
class _ErpInventorySumEditRecState extends State<ErpInventorySumEditRec> { 
