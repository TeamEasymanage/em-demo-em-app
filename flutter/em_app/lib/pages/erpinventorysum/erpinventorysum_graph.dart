...
class ErpInventorySumGraph extends StatefulWidget { 	
  const ErpInventorySumGraph({Key? key}) : super(key: key); 	
	 	
  @override 	
  _ErpInventorySumGraphState createState() => _ErpInventorySumGraphState(); 	
} 	
	 	
class _ErpInventorySumGraphState extends State<ErpInventorySumGraph> { 	
 	
  //List<ErpInventorySum> erpInventorySumList = []; 	
  List<EmChartModel> erpInventorySumList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    ...
    setState(() { 	
      ...
      erpInventorySumList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'ErpInventorySum Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
                    ...
                    child: Container( 	
                      ...
                      child: Padding( 	
                        ...
                        child: (_chartOptSel == 'BarChart') 	
                            ? BarChartSample2( 	
                                erpInventorySumList: erpInventorySumList) 	
                            : LineChart(lineChartErpInventorySum()), 	
                      ), 	
                    ), 	
                  ), 	
                ], 	
  ...
  LineChartData lineChartErpInventorySum() { 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> erpInventorySumList; 	
  const BarChartSample2({Key? key, required this.erpInventorySumList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.erpInventorySumList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	
