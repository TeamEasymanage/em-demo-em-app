...
class EventInvitationViewGraph extends StatefulWidget { 	
  const EventInvitationViewGraph({Key? key}) : super(key: key); 	
	 	
  @override 	
  _EventInvitationViewGraphState createState() => _EventInvitationViewGraphState(); 	
} 	
	 	
class _EventInvitationViewGraphState extends State<EventInvitationViewGraph> { 	
 	
  //List<EventInvitationView> eventInvitationViewList = []; 	
  List<EmChartModel> eventInvitationViewList = []; 	
  String dataJson = 	
  ...
  void initState() { 	
    ...
    setState(() { 	
      ...
      eventInvitationViewList = (json.decode(dataJson) as List) 	
  ...
  Widget build(BuildContext context) { 	
    return Scaffold( 	
      appBar: AppBar( 	
        title: Text(_loading ? 'Loading...' : 'EventInvitationView Graph'), 	
        centerTitle: true, 	
      ), 	
      body: _loading 	
                    ...
                    child: Container( 	
                      ...
                      child: Padding( 	
                        ...
                        child: (_chartOptSel == 'BarChart') 	
                            ? BarChartSample2( 	
                                eventInvitationViewList: eventInvitationViewList) 	
                            : LineChart(lineChartEventInvitationView()), 	
                      ), 	
                    ), 	
                  ), 	
                ], 	
  ...
  LineChartData lineChartEventInvitationView() { 	
...
class BarChartSample2 extends StatefulWidget { 	
  final List<EmChartModel> eventInvitationViewList; 	
  const BarChartSample2({Key? key, required this.eventInvitationViewList}) 	
      : super(key: key); 	
...
class BarChartSample2State extends State<BarChartSample2> { 	
  ...
  void initState() { 	
    ...
    rawBarGroups = widget.eventInvitationViewList 	
        //.sublist(0, 10) 	
        .map((e) => makeGroupData( 	
