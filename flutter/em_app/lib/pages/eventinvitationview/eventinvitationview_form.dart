...
class EventInvitationViewForm extends StatefulWidget { 
  const EventInvitationViewForm({Key? key}) : super(key: key); 
 
  @override 
  _EventInvitationViewFormState createState() => _EventInvitationViewFormState(); 
} 
 
class _EventInvitationViewFormState extends State<EventInvitationViewForm> { 
  ...
  static final formKey = GlobalKey<FormState>(); 
		...
		String? guestVar = ""; 
		String? addressVar = ""; 
		String? phoneNumberVar = ""; 
		String? plusOneVar = ""; 
		String? guestCountVar = ""; 
		String? relatedEventVar = ""; 
...
void didChangeDependencies() { 
  ...
  Widget build(BuildContext context) { 
	return Scaffold( 
        ...
        appBar: AppBar( 
          title: const Text("EventInvitationView Add Form"), 
          centerTitle: true, 
        ), 
        body: Center( 
          child: Padding( 
            ...
            child: SingleChildScrollView(
              ...
              child: Padding( 
				...
				Flexible( 
				  ...
				  // ---------------------------------------------------------------------------------------  
				  // Column Details:  Srl No : [2] [ Name [Guest] : EM Type [CHAR], Java Type [String]  
				  //                  EM size: maxlength: 40, Display Size : 20 
				  // Flutter Details: Field Label [Guest], Name [guest], Type [String]  
				  // ---------------------------------------------------------------------------------------  
				Row( 
				  mainAxisAlignment: MainAxisAlignment.spaceBetween, 
				  children: <Widget>[ 
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.guest),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
					...
					*/  
					//maxLength: 30, 
					onSaved: (value) => setState(() => guestVar = value.toString()), 
				  ), //textformfield 
				), //flexible 
				]), //Widget[] //Row 
                  const SizedBox(height: 10), 
				  // ---------------------------------------------------------------------------------------  
				  // Column Details:  Srl No : [3] [ Name [Address] : EM Type [CHAR], Java Type [String]  
				...
				Flexible( 
                  ...
                  const SizedBox(height: 10), 
				  // ---------------------------------------------------------------------------------------  
				  // Column Details:  Srl No : [4] [ Name [PhoneNumber] : EM Type [CHAR], Java Type [String]  
				  //                  EM size: maxlength: 15, Display Size : 20 
				  // Flutter Details: Field Label [Phone Number], Name [phoneNumber], Type [String]  
				  // ---------------------------------------------------------------------------------------  
				Row( 
				  mainAxisAlignment: MainAxisAlignment.spaceBetween, 
				  children: <Widget>[ 
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.phoneNumber),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
					...
					*/  
					//maxLength: 30, 
					onSaved: (value) => setState(() => phoneNumberVar = value.toString()), 
				  ), //textformfield 
				), //flexible 
				]), //Widget[] //Row 
                  const SizedBox(height: 10), 
				  // ---------------------------------------------------------------------------------------  
				  // Column Details:  Srl No : [5] [ Name [PlusOne] : EM Type [CHAR], Java Type [String]  
				  //                  EM size: maxlength: 40, Display Size : 20 
				  // Flutter Details: Field Label [Plus One], Name [plusOne], Type [String]  
				  // ---------------------------------------------------------------------------------------  
				Row( 
				  mainAxisAlignment: MainAxisAlignment.spaceBetween, 
				  children: <Widget>[ 
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.plusOne),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
					...
					*/  
					//maxLength: 30, 
					onSaved: (value) => setState(() => plusOneVar = value.toString()), 
				  ), //textformfield 
				), //flexible 
				]), //Widget[] //Row 
                  const SizedBox(height: 10), 
				  // ---------------------------------------------------------------------------------------  
				  // Column Details:  Srl No : [6] [ Name [GuestCount] : EM Type [NUMBER], Java Type [long]  
				  //                  EM size: maxlength: 10, Display Size : 10 
				  // Flutter Details: Field Label [Guest Count], Name [guestCount], Type [int]  
				  // ---------------------------------------------------------------------------------------  
				Row( 
				  mainAxisAlignment: MainAxisAlignment.spaceBetween, 
				  children: <Widget>[ 
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.guestCount.toString()),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
					...
					//maxLength: 30, 
					onSaved: (value) => setState(() => guestCountVar = value.toString()), 
				  ), //textformfield 
				), //flexible 
				]), //Widget[] //Row 
                  const SizedBox(height: 10), 
				  // ---------------------------------------------------------------------------------------  
				  // Column Details:  Srl No : [7] [ Name [RelatedEvent] : EM Type [CHAR], Java Type [String]  
				  //                  EM size: maxlength: 40, Display Size : 20 
				  // Flutter Details: Field Label [Related Event], Name [relatedEvent], Type [String]  
				  // ---------------------------------------------------------------------------------------  
				Row( 
				  mainAxisAlignment: MainAxisAlignment.spaceBetween, 
				  children: <Widget>[ 
				Flexible( 
					  child:  
				  TextFormField( 
					//EDT-INIT-VAL      initialValue: getEmStrOpt(foundRecord.relatedEvent),   
					  /* 
					  */ 
					  /* 
					  inputFormatters: [ 
					...
					*/  
					//maxLength: 30, 
					onSaved: (value) => setState(() => relatedEventVar = value.toString()), 
				  ), //textformfield 
				), //flexible 
				]), //Widget[] //Row 
                  const SizedBox(height: 10), 
 ...
 */ 
                          ...
                          EventInvitationView newEventInvitationView = EventInvitationView( 
					   id: getEmIntStr(idVar) , 
					   guest: guestVar , 
					   address: addressVar , 
					   phoneNumber: phoneNumberVar , 
					   plusOne: plusOneVar , 
					   guestCount: getEmIntStrOpt(guestCountVar) , 
					   relatedEvent: relatedEventVar , 
							  ); 
 
                          EventInvitationViewService.EventInvitationViewCreate( 
                                  newEventInvitationView.toJson()) 
                              .then((message) { 
                                    message == "EventInvitationView Added Successfully" 
                                        ? null	
                                        : showDialog(	
                                            context: context,	
